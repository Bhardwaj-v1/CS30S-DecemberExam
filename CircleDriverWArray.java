 ...
 *                  add an array of Cirlce objects
 * 
 *************************************************************/

public class CircleDriverWArray {
    ...
    // ***** variables *****
        ...
        Circle[] circles = new Circle[10];      // arrrghhh a magic number, oh well
    ...
    // ***** Main Processing *****
        ...
        circles[0] = c1;            // now there are two pointers to c1
        circles[1] = c2;
        circles[2] = new Circle(2.5);      // add a new object
